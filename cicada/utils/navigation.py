...
# def view_of_net(state, pos, log_intercepts=False):

#     view_of_net = 1.0

#     for opp_pos in state.opp_pos:
...
#         view_of_net = max(
#             0, view_of_net - pct_hidden
#         )

#     # scale by angle of net in view (decreases with distance
#     # and off-centerness)
#     post_angle_a = angle(opp_post_a - pos)
#     post_angle_b = angle(opp_post_b - pos)
#     net_angle = angle_diff(post_angle_a, post_angle_b)
